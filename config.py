...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/themishra05/Alone",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SHAYRI_W0RLD")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/AKHANDBHARRAT")
